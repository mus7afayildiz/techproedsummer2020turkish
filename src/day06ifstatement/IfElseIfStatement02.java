...
public class IfElseIfStatement02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Sýnav notunu tamsayý olarak giriniz");
		int not = scan.nextInt();
		
		if(not<0) {System.out.println("Yanlýþ deðer girdiniz");
		}else if(not<50){System.out.println("Kaldýnýz");
		}else if(not<80) {System.out.println("Geçtiniz");
